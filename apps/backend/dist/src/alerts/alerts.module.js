...
exports.AlertsModule = AlertsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([alert_entity_1.Alert, pratica_entity_1.Pratica, avvocato_entity_1.Avvocato]), notifications_module_1.NotificationsModule],
