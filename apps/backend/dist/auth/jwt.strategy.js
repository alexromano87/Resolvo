...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    clienteRepository;
    configService;
    constructor(userRepository, clienteRepository, configService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            ignoreExpiration: false,
            secretOrKey: configService.get('JWT_SECRET', 'your-secret-key-change-in-production-12345678'),
        });
    ...
    async validate(payload) {
        ...
        if (!user || user.tokenVersion !== payload.tokenVersion) {
            throw new common_1.UnauthorizedException('Utente non trovato o disattivato');
        }
